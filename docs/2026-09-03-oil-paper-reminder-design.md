...
| 예약됨 | 「다음 알림 **15:20** · 또 썼으면 눌러요」(blue-dark 600) | check + 「예약됨」 | ghost 「그만 받기」 |
...
- `aria-label`: 행동 버튼 「기름종이 썼어요」 / 「기름종이 또 썼어요」 / 「기름종이 다음 알림 받기」 · 「기름종이 알림 그만 받기」. `role="switch"`는 **안 쓴다** — 켜짐의 반대가 「꺼짐」이 아니라 「오늘은 없음」이라 스위치 은유가 틀린다.
